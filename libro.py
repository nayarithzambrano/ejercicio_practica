...
botonLeido=Button (ventana, text="Libro ya leido",command=eliminarLibro, bg="#009", fg="white") .place (x=550,y=458)

imgbtn=PhotoImage(file="salir.png")

sal =Button(ventana, image=imgbtn, command=salir) .place (x=350, y=70)
